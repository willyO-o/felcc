...
@section('title', 'Restablecer Contraseña - FELCC')
                            ...
                            <div class="p-2 mt-4">
                                <form method="POST" action="{{ route('password.update') }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="email" class="form-control @error('email') is-invalid @enderror" id="email" name="email" value="{{ $email ?? old('email') }}" placeholder="Ingrese su correo electrónico" required autocomplete="email" autofocus>
                                        @error('email')
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label" for="password-input">Nueva Contraseña <span class="text-danger">*</span></label>
                                        <div class="position-relative auth-pass-inputgroup">
                                            <input type="password" class="form-control pe-5 password-input @error('password') is-invalid @enderror" placeholder="Ingrese su nueva contraseña" id="password-input" name="password" required autocomplete="new-password">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="position-relative auth-pass-inputgroup">
                                            <input type="password" class="form-control pe-5 password-input" placeholder="Confirme su nueva contraseña" id="password-confirm" name="password_confirmation" required autocomplete="new-password">
                                            <button class="btn btn-link position-absolute end-0 top-0 text-decoration-none text-muted shadow-none password-addon" type="button"><i class="ri-eye-fill align-middle"></i></button>
                                        </div>
                                    </div>
