                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-lg-6 ">
                                <div>
                                    ...
                                    <input type="text" class="form-control txtMayuscula" id="asignado"
                            ...
                            <div class="col-12">
                                <label for="imagen_mandamiento" class="form-label">Adjuntar Foto/PDF del Mandamiento</label>
                                <div class="input-group">
                                ...
                                <div class="col-lg-6 requerido_ejecutado" style="display: none;">
                                    <div>
                                        ...
                                        <input type="text" class="form-control txtMayuscula" id="ejecutado_por"
                                             placeholder="Ingrese nombre de quien ejecutó el mandamiento"
                                            name="ejecutado_por" value="">
                                    </div>
                                </div><!--end col-->
                                <div class="col-lg-6 requerido_ejecutado"   style="display: none;">
                                    <div>
