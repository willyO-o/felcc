                    ...
                    <div class="d-flex flex-column-reverse flex-md-row justify-content-between align-items-center gap-2">
                        ...
                        <div class="col">
                            <div class="input-group">
                                ...
                                <input type="text" id="filtroFechas" class="form-control"
                                    placeholder="Fecha de ejecución" data-toggle="daterangepicker"
                                    aria-label="Rango de fechas" autocomplete="off">
                                <button type="button" class="btn btn-outline-danger" id="btnLimpiarFechas"
...
@section('js')
    ...
    <script src="{{ url('/assets/js/mandamientos/consultas.js?v=' . config('app.aplicacion.version')) }}"></script>
