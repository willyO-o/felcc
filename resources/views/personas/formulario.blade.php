...
<form
    ...
    <div class="modal-body" style="max-height: calc(90vh - 200px); overflow-y: auto; padding: 1.5rem;">
        <div class="row g-3">
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="ci" name="ci" maxlength="20"
                    value="{{ old('ci', $persona->ci ?? '') }}" placeholder="Ej: 1234567 LP">
                <div class="invalid-feedback" id="error-ci"></div>
            </div>

            <div class="col-md-6">
                <label for="complemento" class="form-label">Complemento CI</label>
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="lugar_nacimiento" name="lugar_nacimiento" maxlength="250"
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="nombre_conyuge" name="nombre_conyuge" maxlength="250"
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="ocupacion" name="ocupacion" maxlength="150"
            ...
            <div class="col-md-12">
                ...
                <textarea class="form-control" id="domicilio" name="domicilio" rows="2" maxlength="500"
            ...
            <div class="col-12">
                <label for="fotos" class="form-label">
                    Fotos
                    <small class="text-muted">(JPEG, PNG, WebP - máx 2MB por archivo)</small>
                </label>
    ...
    <div class="modal-footer border-top" style="position: sticky; bottom: 0; background-color: #fff; z-index: 1000;">
