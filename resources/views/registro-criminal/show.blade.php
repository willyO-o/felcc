                                    ...
                                    <ul class="nav nav-tabs nav-tabs-custom nav-success" id="nav-tab" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active" id="nav-speci-tab" data-bs-toggle="tab"
                                                ...
                                                Otros Registros
                                                <span
                                                    class="badge bg-danger">{{ $otrosRegistros?->count() ?? 0 }}</span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table mb-0">
                                                <tbody>
                                                    ...
                                                    @empty
                                                        <tr>
                                                            <td colspan="100%" class="text-center py-4">No se encontraron mas registros.</td>
                                                        </tr>
                                                    @endforelse
                                        ...
                                        <div>
                                            ...
                                            <table class="table mb-0 small table-sm">
                                                <tbody>
                                                    ...
                                                    @empty
                                                        <tr>
                                                            <td colspan="100%" class="text-center py-4">No se encontraron mandamientos.</td>
                                                        </tr>
                                                    @endforelse
