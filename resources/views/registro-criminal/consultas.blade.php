...
@section('page-title', 'Consultas de Registros Criminales')
...
@section('breadcrumb')
    <div class="page-title-right">
        <ol class="breadcrumb m-0">
            ...
            <li class="breadcrumb-item active">Registros Criminales</li>
        </ol>
    </div>
@endsection
                    ...
                    <div class="d-flex flex-column-reverse flex-md-row justify-content-between align-items-center gap-2">
                        <div class="col-md-5 mt-2 mt-md-0 ">
                            <div class="input-group">
                                ...
                                <span class="input-group-text btn btn-primary" id="btnBuscar"><i
...
@section('js')
    ...
    <script src="{{ url('assets/js/registro-criminal/consultas.js?v=' . config('app.aplicacion.version')) }}"></script>
@endsection
