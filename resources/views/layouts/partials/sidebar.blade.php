        ...
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                @canany(['superadmin', 'administrador', 'tecnico_daci'])
                    ...
                    <li class="nav-item d-none">
                        <a class="nav-link menu-link" href="{{ route('ciudadanos.index') }}">
                ...
                @canany(['superadmin', 'administrador', 'tecnico_daci'])
                    <li class="menu-title d-none"><span data-key="t-menu">EREBOR</span></li>
                    <li class="nav-item d-none">
                ...
                @canany(['superadmin', 'administrador', 'tecnico_daci'])
                    <!-- Usuarios -->
                    <li class="menu-title d-none d-none"><span data-key="t-menu">Importar</span></li>
                @endcanany
                    ...
                    <li class="nav-item d-none">
                        ...
                        <div class="collapse menu-dropdown" id="sidebarImportar">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item d-none">
                                    <a href="{{ route('personas.importar.index') }}" class="nav-link">Importar
                                        Personas</a>
                                </li>
                ...
                @canany(['superadmin', 'administrador'])
                    <li class="menu-title d-none"><span data-key="t-menu">Reportes</span></li>
