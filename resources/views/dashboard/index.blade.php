                                    ...
                                    <div class="row g-3 mb-0 align-items-center">
                                        <div class="col-auto">
                                            <button type="button" class="btn btn-soft-success shadow-none"
                                                onclick="window.location.href='{{ route('mandamientos.create') }}'">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="flex-grow-1 overflow-hidden">
                                        <p class="text-uppercase fw-medium text-muted text-truncate mb-0">Total Mandamientos
                                        </p>
                                    </div>
                                    ...
                                    <div>
                                        <h4 class="fs-22 fw-semibold ff-secondary mb-4">
                                            <span class="counter-value"
                                                data-target="{{ \App\Models\Mandamiento::count() }}">0</span>
                                        </h4>
                                        <a href="{{ route('mandamientos.index') }}" class="text-decoration-underline">Ver
                                            todos</a>
                                    </div>
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="card card-animate">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="flex-grow-1 overflow-hidden">
                                        <p class="text-uppercase fw-medium text-muted text-truncate mb-0">Registro Criminal
                                        </p>
                                    </div>
                                    <div class="flex-shrink-0">
                                ...
                                <div class="d-flex align-items-end justify-content-between mt-4">
                                    <div>
                                        <h4 class="fs-22 fw-semibold ff-secondary mb-4">
                                            <span class="counter-value"
                                                data-target="{{ \App\Models\RegistroCriminal::count() }}">0</span>
                                        </h4>
                                        <a href="{{ route('registro-criminal.index') }}"
                                            class="text-decoration-underline">Ver registros</a>
                                    </div>
                                    <div class="avatar-sm flex-shrink-0">
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="card card-animate">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="flex-grow-1 overflow-hidden">
                                        <p class="text-uppercase fw-medium text-muted text-truncate mb-0">Personas
                                            Registradas</p>
                                    </div>
                                    <div class="flex-shrink-0">
                                ...
                                <div class="d-flex align-items-end justify-content-between mt-4">
                                    <div>
                                        <h4 class="fs-22 fw-semibold ff-secondary mb-4">
                                            <span class="counter-value" data-target="{{ \App\Models\Persona::count() }}">0</span>
                                        </h4>
                                        <a href="{{ route('personas.index') }}" class="text-decoration-underline">Ver Personas</a>
                                    </div>
                                    <div class="avatar-sm flex-shrink-0">
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="card card-animate">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="flex-grow-1 overflow-hidden">
                                        <p class="text-uppercase fw-medium text-muted text-truncate mb-0">Vehículos Registrados</p>
                                    </div>
                                    <div class="flex-shrink-0">
                                        <h5 class="text-success fs-14 mb-0">
                                            <i class="ri-arrow-right-up-line fs-13 align-middle"></i> Activos
                                ...
                                <div class="d-flex align-items-end justify-content-between mt-4">
                                    <div>
                                        <h4 class="fs-22 fw-semibold ff-secondary mb-4">
                                            <span class="counter-value" data-target="{{ \App\Models\Vehiculo::count() }}">0</span>
                                        </h4>
                                        <a href="{{ route('vehiculos.index') }}" class="text-decoration-underline">Ver
